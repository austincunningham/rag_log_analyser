...
try:
    ...
    print("\n\n⏹️  Database setup interrupted by user. Exiting...")
    sys.exit(0)
...
try:
    ...
    print("\n\n⏹️  Vector database creation interrupted by user. Exiting...")
    sys.exit(0)
...
try:
    while True:
       ...
       try:
           ...
           print("\n\n⏹️  Query processing interrupted. You can ask another question or type 'exit' to quit.")
           continue
